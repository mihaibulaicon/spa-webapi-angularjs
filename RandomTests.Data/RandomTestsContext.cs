using RandomTests.Data.Configurations;
...
namespace RandomTests.Data
{
    public class RandomTestsContext : DbContext
    {
        public RandomTestsContext()
            : base("RandomTests")
        {
            Database.SetInitializer<RandomTestsContext>(null);
        }
